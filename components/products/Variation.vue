  ...
  <div class="field">
    ...
    <div class="control">
      <div class="select is-fullwidth">
        <select  name="variation" id="variation" :value="selectedVariationId" @change="changed($event, type)">
          <option value>Please choose</option>
          <option :value="variation.id" v-for="variation in variations" :key="variation.id" :disabled="!variation.in_stock">
            {{variation.name}}
